...
/* --- WHY HARMONIA: THEME-AWARE STYLES --- */
        ...
        .science-card.personality-card.line-1-visible .inner-line.line-1 {
            opacity: 1;
            stroke-dashoffset: 0;
        }

        .science-card.personality-card.line-2-visible .inner-line.line-2 {
            opacity: 1;
            stroke-dashoffset: 0;
        }

        .science-card.personality-card.line-3-visible .inner-line.line-3 {
            opacity: 1;
            stroke-dashoffset: 0;
        }
        ...
        .science-card.synthesis-card.logo-visible .harmonia-logo-center {
            transform: translate(-50%, -50%) scale(1);
            opacity: 1;
        }

        .science-card.synthesis-card.logo-spinning .harmonia-logo-center {
            animation: logoSpinAndTravel 1.4s cubic-bezier(0.4, 0, 0.2, 1) forwards;
        }

        /* Logo spins 720° while traveling to top-left header position */
        @keyframes logoSpinAndTravel {
            0% { 
                top: 50%;
                left: 50%;
            ...
            100% { 
                top: 2.5rem;
                left: 2.5rem;
                transform: translate(0, -5px) scale(1) rotate(720deg);
                opacity: 1;
                width: 100px;
                height: 100px;
            }
        ...
        /* Final resting state - in header position, aligned with title */
        ...
        /* Click spin animation for logo */
        .harmonia-logo-center.click-spin {
            animation: clickSpin 0.6s ease-out forwards;
        }
        
        @keyframes clickSpin {
            0% { transform: translate(0, -5px) scale(1) rotate(0deg); }
            100% { transform: translate(0, -5px) scale(1) rotate(360deg); }
        }
        ...
        @media (max-width: 768px) {
            ...
            .science-card.synthesis-card .harmonia-logo-center {
                width: 90px;
                height: 90px;
            }
            .science-card.synthesis-card.logo-in-header .harmonia-logo-center {
            ...
            .science-card.synthesis-card.logo-spinning .harmonia-logo-center {
                animation: logoSpinInPlaceTablet 1.4s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            /* Click spin animation for tablet */
            .science-card.synthesis-card.logo-in-header .harmonia-logo-center.click-spin {
                animation: clickSpinTablet 0.6s ease-out forwards;
            }
            @keyframes clickSpinTablet {
                0% { transform: translate(-50%, 0) scale(1) rotate(0deg); }
                100% { transform: translate(-50%, 0) scale(1) rotate(360deg); }
            }
            @keyframes logoSpinInPlaceTablet {
                0% { 
                    top: 50%;
                    left: 50%;
                    transform: translate(-50%, -50%) scale(1) rotate(0deg);
        ...
        @media (max-width: 480px) {
            ...
            .science-card.synthesis-card.logo-spinning .harmonia-logo-center {
                animation: logoSpinInPlacePhone 1.4s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            /* Click spin animation for phone */
            .science-card.synthesis-card.logo-in-header .harmonia-logo-center.click-spin {
                animation: clickSpinPhone 0.6s ease-out forwards;
            }
            @keyframes clickSpinPhone {
                0% { transform: translate(-50%, 0) scale(1) rotate(0deg); }
                100% { transform: translate(-50%, 0) scale(1) rotate(360deg); }
            }
            @keyframes logoSpinInPlacePhone {
                0% { 
                    top: 50%;
                    left: 50%;
                    transform: translate(-50%, -50%) scale(1) rotate(0deg);
        ...
        @media (min-width: 768px) and (max-width: 1024px) {
            ...
            .science-card.synthesis-card.logo-spinning .harmonia-logo-center {
                animation: logoSpinAndTravelTabletMid 1.4s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            @keyframes logoSpinAndTravelTabletMid {
                0% { 
                    top: 50%;
                    left: 50%;
                    transform: translate(-50%, -50%) scale(1) rotate(0deg);
